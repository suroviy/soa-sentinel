...
class SwitchRadio extends Radio
{

	protected $view 			= "switchradio";
	protected $size				= "normal";
	protected $animate			= true;
	protected $indeterminate	= false;
	protected $inverse			= false;
	protected $radioAllOff		= false;
	...
	public function radioAllOff($radioAllOff=null)
	{
		if (is_null($radioAllOff))
		{
